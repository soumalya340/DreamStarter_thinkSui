...
const BoxComponent = () => {
  ...
  // const handleMintClick = () => {
    ...
    async function handleMintClick() {
          ...
          console.log('current connected chain (network)', wallet.chain?.name)
          const tx = new TransactionBlock();
          const packageObjectId = "0x672ab914fa8639a80e7509a89ebf52b2167a5c5485a3257243652d90344cb173";
          tx.moveCall({
            target: `${packageObjectId}::Sou nft::Mint`,
            arguments: [tx.pure(wallet.name),tx.pure("description"), 
              tx.pure(URL)
